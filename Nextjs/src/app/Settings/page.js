...
import { UserAuth, handleSignOut } from "../context/AuthContext";
    ...
    <div className="min-h-screen font-sans bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1 md:col-span-3 bg-white rounded-lg shadow-md p-6 hover:bg-zinc-900 hover:text-white">
          ...
          <div className="md:col-span-1 bg-white rounded-lg shadow-md p-6 hover:bg-zinc-900 hover:text-white">
          ...
          <div className="col-span-1 md:col-span-3 flex justify-end">
            <button
              ...
              className="bg-slate-800 hover:bg-blue-900 text-white hover:text-white font-semibold py-2 px-4 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              Logout
            </button>
          </div>
