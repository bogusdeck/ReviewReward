...
const Footer = () => {
  return (
    <footer className="p-4 bg-black  sm:p-6 w-screen h-2/3 ">
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex items-center justify-center md:justify-start">
            <a
              href="#"
              className="flex items-center justify-center  py-1 px-2 text-white hover:text-gray-400"
            >
                <Image src={Logo}
          height={50}
          />
          ...
          <div className="grid grid-cols-2 gap-10 sm:gap-6 sm:grid-cols-3 subfont tracking-wider">
            ...
            <div>
              ...
              <ul className="text-white">
                <li className="mb-4">
                  <a
                    href="https://github.com/Prome-theus" target="blank"
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              href="https://www.instagram.com/review_reward/" target="blank"
